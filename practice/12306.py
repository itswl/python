...
class BrushTicket(object):
    ...
    def __init__(self, user_name, password, passengers, from_time, from_station, to_station, number, seat_type, receiver_mobile, receiver_email):
        ...
        self.executable_path = 'C:\\Users\imwl\AppData\Local\Programs\Python\Python37\Scripts\chromedriver.exe'
    ...
    def do_login(self):
        ...
        while True:
            if self.driver.url != self.init_my_url:
                print("url1 = {}, url2 = {}".format(self.driver.url, self.init_my_url))
                sleep(1)
            else:
                print('ok!!!')
                break
    ...
    def send_mail(self, receiver_address, content):
        ...
        port = 587
        sender = 'imwl@live.com'  # 你的发件邮箱号码
        pwd = 'Wl19950707'  # 不是登陆密码，是客户端授权密码
        # 发件信息
...
if __name__ == '__main__':
    ...
    receiver_email = "642670121@qq.com"
